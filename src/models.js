...
const userSchema=new mongoose.Schema({
  ...
  // totp — secret encrypted w/ AES-256-GCM before storage
  totpSecret: String,
...
//ponytail: FATF Travel Rule R.16 record. populated after remit transfers.
...
// ponytail: SAR — flagged by monitoring rules, reviewed by admin
