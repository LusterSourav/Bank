//jaro-winkler for indian name matching. swap for cashfree when available
// Name Match API or HyperVerge when scaling past 10K verifications.
...
// Normalize Indian names: uppercase, strip honorifics, collapse whitespace
...
function matchNames(name1, name2){
  ...
  // One is subset of the other (handles initials)
